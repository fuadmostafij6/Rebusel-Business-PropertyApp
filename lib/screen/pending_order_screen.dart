...
import 'package:rebusel/controller/pending_order_controler.dart';

class PendiingOrderScreen extends StatefulWidget {
  const PendiingOrderScreen({Key? key}) : super(key: key);

  @override
  State<PendiingOrderScreen> createState() => _PendiingOrderScreenState();
}

class _PendiingOrderScreenState extends State<PendiingOrderScreen> {
  final PendingOrderController _myOrderController = Get.put(PendingOrderController());
  @override
  void initState() {
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: const EdgeInsets.only(
                                            ...
                                            right: 10,
                                            bottom: 10),
                                        child: Text("Pending",style: TextStyle(fontSize: 16,color: Colors.amber),),
                                      ),
                                    ),
                                  ],
                                ),
