...
import 'package:rebusel/controller/complete_order_controller.dart';
import 'package:rebusel/controller/pending_order_controler.dart';
import 'package:rebusel/controller/processing_controller.dart';
import 'package:rebusel/controller/reject_controller.dart';
...
class _RejectScreenState extends State<RejectScreen> {
  final RejectController _myOrderController = Get.put(RejectController());
  @override
  void initState() {
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: const EdgeInsets.only(
                                            ...
                                            right: 10,
                                            bottom: 10),
                                        child: Text("Reject",style: TextStyle(fontSize: 16,color: Colors.amber),),
                                      ),
                                    ),
                                  ],
                                ),
